...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <form:form action="/donation/new-donation" method="post" modelAttribute="donation">
            ...
            <div data-step="3">
                ...
                <c:forEach items="${institutions}" var="institution">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <input type="radio" id="institution" name="institution" value="${institution.id}" />
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-section--column">
                            ...
                            <div class="form-group form-group--inline">
                                <label> Godzina
                                    <form:input type="time" path="pickUpTime" id="time" />
                                </label>
                            </div>
                            ...
                            <div class="form-group form-group--inline">
                                <label>
                                    Uwagi dla kuriera
                                    <form:textarea rows="5" path="pickUpComment" id="comment" />
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group form-group--buttons">
                        <button type="button" class="btn prev-step">Wstecz</button>
                        <button type="button" class="btn next-step" id="show-summary">Dalej</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="summary-quantity">- 0 -</span>
                            </li>
